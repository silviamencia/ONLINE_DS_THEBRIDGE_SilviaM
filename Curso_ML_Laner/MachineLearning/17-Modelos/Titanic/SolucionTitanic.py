...
import os
import pandas as pd
os.chdir(r"C:\Users\borja\OneDrive\Documents\C2B\Bootcamp\Titanic")
...
# Definimos el modelo
RF=RandomForestClassifier(bootstrap=True, class_weight=None, criterion='gini',max_depth=None, max_features='auto', max_leaf_nodes=None,min_impurity_decrease=0.0,min_samples_leaf=1, min_samples_split=2,min_weight_fraction_leaf=0.0, n_estimators=1000, n_jobs=-1, oob_score=False, random_state=None, verbose=0,warm_start=False)
...
predicciones = RegLog.predict(test_completos)
