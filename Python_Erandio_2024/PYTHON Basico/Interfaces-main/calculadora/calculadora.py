...
from calcula import calcula, operaciones
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_resultado.clicked.connect(self.calcularesultado)
    ...
    def calcularesultado(self):
        
        result = calcula(self.operando1, self.operacion, self.operando2)
        self.lcdNumber.display(result)
        self.operando1 = str(result)
        self.operando2 = ""
        self.operacion = ""
